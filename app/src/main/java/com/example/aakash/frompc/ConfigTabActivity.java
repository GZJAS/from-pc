...
public class ConfigTabActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        if (checkBox.isChecked()) {
            ...
            savePreferences("storedIpTab", add);
            savePreferences("storedPortTab", port.getText().toString());
